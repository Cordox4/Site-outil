...
export const tools = {
  about: {
    name: 'À propos', icon: 'info', desc: 'Ce que fait OutilsBox et pourquoi il existe.', cat: null,
    render(root) {
      root.append(panel(
        el('h3', {}, 'Notre mission'),
  ...
  contact: {
    name: 'Contact', icon: 'mail', desc: 'Une question, un bug ou une suggestion ? Écrivez-nous.', cat: null,
    render(root) {
      root.append(panel(
        el('h3', {}, 'Nous écrire'),
  ...
  privacy: {
    name: 'Confidentialité', icon: 'lock', desc: 'Comment vos données sont traitées sur OutilsBox.', cat: null,
    render(root) {
      root.append(panel(
  ...
  terms: {
    name: "Conditions d'utilisation", icon: 'scroll', desc: "Règles d'utilisation du site et des outils.", cat: null,
    render(root) {
      root.append(panel(
