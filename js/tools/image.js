...
export const tools = {
  'compress-image': {
    name: 'Compresser image', icon: 'compress', desc: 'Réduisez le poids d\'une image (JPG/WebP).', cat: 'image',
    render(root) {
  ...
  'resize-image': {
    name: 'Redimensionner image', icon: 'ruler', desc: 'Changez les dimensions d\'une image.', cat: 'image',
    render(root) {
      const p = panel(); root.append(p);
  ...
  'crop-image': {
    name: 'Recadrer image', icon: 'crop', desc: 'Recadrez une zone rectangulaire.', cat: 'image',
    render(root) {
      const p = panel(); root.append(p);
  ...
  ...convertTool('png-to-jpg', 'PNG → JPG', 'image', 'Convertissez un PNG en JPG.', 'image/jpeg', '.jpg', {
    intro: [
  ...
  ...convertTool('jpg-to-png', 'JPG → PNG', 'image', 'Convertissez un JPG en PNG.', 'image/png', '.png', {
    intro: [
  ...
  ...convertTool('webp-convert', 'Conversion WebP', 'image', 'Convertissez une image en WebP.', 'image/webp', '.webp', {
    intro: [
  ...
  ...convertTool('avif-convert', 'Conversion AVIF', 'image', 'Convertissez une image en AVIF (selon le navigateur).', 'image/avif', '.avif', {
    intro: [
  ...
  'watermark-image': {
    name: 'Filigrane image', icon: 'droplet', desc: 'Ajoutez un filigrane répété sur toute l\'image.', cat: 'image',
    render(root) {
      const p = panel(); root.append(p);
      let file, img;
      singleImage(p, (f, i) => { file = f; img = i; go.disabled = false; });
  ...
  'ocr-image': {
    name: 'OCR image', icon: 'type', desc: 'Extrayez le texte d\'une image.', cat: 'image',
    render(root) {
      const p = panel(); root.append(p);
      let file;
  ...
  'remove-bg': {
    name: 'Suppression arrière-plan', icon: 'wand', desc: 'Détourez le sujet d\'une image.', cat: 'image', badge: 'API',
    render(root) { root.append(panel(backendNotice('La suppression d\'arrière-plan par IA'))); },
  },

  'exif-viewer': {
    name: 'Exif viewer', icon: 'camera', desc: 'Affichez les métadonnées EXIF d\'une photo.', cat: 'image',
    render(root) {
      const p = panel(); root.append(p);
      let file;
      singleImage(p, (f) => { file = f; go.disabled = false; });
