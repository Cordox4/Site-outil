...
export const tools = {
  'sitemap-generator': {
    name: 'Générateur de sitemap', icon: 'map', desc: 'Créez un sitemap.xml à partir d\'une liste d\'URL.', cat: 'seo',
    render(root) {
  ...
  'robots-txt': {
    name: 'Générateur robots.txt', icon: 'bot', desc: 'Créez un fichier robots.txt.', cat: 'seo',
    render(root) {
      const p = panel(); root.append(p);
  ...
  'meta-analyzer': {
    name: 'Analyse meta', icon: 'tag', desc: 'Analysez les balises meta d\'une page (collez le HTML).', cat: 'seo',
    render(root) {
      const p = panel(); root.append(p);
  ...
  'heading-analyzer': {
    name: 'Analyse des titres SEO', icon: 'heading', desc: 'Vérifiez la structure H1-H6 (collez le HTML).', cat: 'seo',
    render(root) {
      const p = panel(); root.append(p);
  ...
  'keyword-density': {
    name: 'Densité de mots-clés', icon: 'trendUp', desc: 'Analysez la fréquence des mots d\'un texte.', cat: 'seo',
    render(root) {
      const p = panel(); root.append(p);
  ...
  'keyword-extractor': {
    name: 'Extracteur de mots-clés', icon: 'key', desc: 'Extrayez les expressions clés (bigrammes).', cat: 'seo',
    render(root) {
      const p = panel(); root.append(p);
      const inp = el('textarea', { placeholder: 'Collez votre texte…' });
      const out = el('div');
  ...
  'slug-generator': {
    name: 'Générateur de slug', icon: 'link', desc: 'Créez un slug URL propre.', cat: 'seo',
    render(root) {
      const p = panel(); root.append(p);
  ...
  'url-encode': {
    name: 'URL Encoder', icon: 'link', desc: 'Encodez une chaîne pour une URL.', cat: 'seo',
    render(root) {
      const p = panel(); root.append(p);
  ...
  'url-decode': {
    name: 'URL Decoder', icon: 'link', desc: 'Décodez une chaîne URL.', cat: 'seo',
    render(root) {
      const p = panel(); root.append(p);
      const inp = el('textarea', { class: 'mono' }); const out = el('textarea', { class: 'mono', readonly: true });
