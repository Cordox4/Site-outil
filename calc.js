...
export const tools = {
  'vat': {
    name: 'Calcul TVA', icon: 'receipt', desc: 'Calculez HT, TVA et TTC.', cat: 'calc',
    render: (r) => calc(r, [
  ...
  'percentage': {
    name: 'Calcul pourcentage', icon: 'percent', desc: 'Pourcentage, variation et proportion.', cat: 'calc',
    render: (r) => calc(r, [
  ...
  'bmi': {
    name: 'Calcul IMC', icon: 'scale', desc: 'Indice de masse corporelle.', cat: 'calc',
    render: (r) => calc(r, [
  ...
  'age': {
    name: 'Calcul âge', icon: 'calendar', desc: 'Âge exact à partir d\'une date de naissance.', cat: 'calc',
    render(root) {
      const p = panel(); root.append(p);
  ...
  'compound-interest': {
    name: 'Intérêts composés', icon: 'trendUp', desc: 'Projection d\'épargne avec intérêts composés.', cat: 'calc',
    render: (r) => calc(r, [
  ...
  'mortgage': {
    name: 'Prêt immobilier', icon: 'home', desc: 'Mensualité et coût total d\'un crédit.', cat: 'calc',
    render: (r) => calc(r, [
  ...
  'calories': {
    name: 'Calcul calories', icon: 'flame', desc: 'Besoins caloriques journaliers (BMR/TDEE).', cat: 'calc',
    render(root) {
      const p = panel(); root.append(p);
