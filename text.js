...
export const tools = {
  'word-counter': {
    name: 'Compteur de mots', icon: 'hash', desc: 'Comptez mots, phrases et paragraphes.', cat: 'text',
    render(root) {
  ...
  'char-counter': {
    name: 'Compteur de caractères', icon: 'type', desc: 'Comptez les caractères (avec/sans espaces).', cat: 'text',
    render(root) {
      const p = panel(); root.append(p);
      const ta = el('textarea', { placeholder: 'Collez votre texte…' });
      const out = el('div', { style: 'margin-top:14px' });
  ...
  'reading-time': {
    name: 'Lecture estimée', icon: 'clock', desc: 'Estimez le temps de lecture.', cat: 'text',
    render(root) {
      const p = panel(); root.append(p);
      const ta = el('textarea', { placeholder: 'Collez votre texte…' });
  ...
  'lorem-ipsum': {
    name: 'Lorem Ipsum', icon: 'fileText', desc: 'Générez du faux texte de remplissage.', cat: 'text',
    render(root) {
      const p = panel(); root.append(p);
  ...
  'text-diff': {
    name: 'Diff texte', icon: 'shuffle', desc: 'Comparez deux textes ligne par ligne.', cat: 'text',
    render(root) {
      const p = panel(); root.append(p);
  ...
  'markdown-preview': {
    name: 'Markdown Preview', icon: 'fileText', desc: 'Prévisualisez du Markdown en direct.', cat: 'text',
    render(root) {
      const p = panel(); root.append(p);
