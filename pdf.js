...
export const tools = {
  'merge-pdf': {
    name: 'Fusion PDF', icon: 'merge', desc: 'Combinez plusieurs PDF en un seul.', cat: 'pdf',
    render(root) {
  ...
  'split-pdf': {
    name: 'Division PDF', icon: 'scissors', desc: 'Extrayez des pages ou séparez chaque page.', cat: 'pdf',
    render(root) {
      const p = panel(); root.append(p);
      let files = [];
      const zone = el('div');
  ...
  'compress-pdf': {
    name: 'Compression PDF', icon: 'compress', desc: 'Réduisez la taille d\'un PDF.', cat: 'pdf',
    render(root) {
      const p = panel(); root.append(p);
      let files = [];
  ...
  'pdf-to-jpg': {
    name: 'PDF → JPG', icon: 'image', desc: 'Convertissez chaque page en image JPG.', cat: 'pdf',
    render(root) {
      const p = panel(); root.append(p);
      let files = [];
      fileCollector(p, { multiple: false, accept: '.pdf', onChange: f => { files = f; } });
  ...
  'jpg-to-pdf': {
    name: 'JPG → PDF', icon: 'file', desc: 'Assemblez des images en un PDF.', cat: 'pdf',
    render(root) {
      const p = panel(); root.append(p);
      let files = [];
  ...
  'rotate-pdf': {
    name: 'Rotation PDF', icon: 'rotate', desc: 'Faites pivoter toutes les pages, à n\'importe quel angle.', cat: 'pdf',
    render(root) {
      const p = panel(); root.append(p);
      let files = [];
      fileCollector(p, { multiple: false, accept: '.pdf', onChange: f => { files = f; } });
  ...
  'unlock-pdf': {
    name: 'Déverrouillage PDF', icon: 'unlock', desc: 'Retirez la protection d\'un PDF que vous possédez.', cat: 'pdf',
    render(root) {
      const p = panel(); root.append(p);
      let files = [];
      fileCollector(p, { multiple: false, accept: '.pdf', onChange: f => { files = f; } });
  ...
  'protect-pdf': {
    name: 'Protection PDF', icon: 'lock', desc: 'Ajoutez un mot de passe à un PDF.', cat: 'pdf', badge: 'API',
    render(root) {
      const p = panel(); root.append(p);
  ...
  'pdf-to-word': {
    name: 'PDF → Word', icon: 'fileText', desc: 'Convertissez un PDF en document Word.', cat: 'pdf', badge: 'API',
    render(root) { root.append(panel(backendNotice('La conversion PDF → Word (mise en page fidèle)'))); },
  },
  'word-to-pdf': {
    name: 'Word → PDF', icon: 'file', desc: 'Convertissez un document Word en PDF.', cat: 'pdf', badge: 'API',
